...
.method public readBinary()Ljava/nio/ByteBuffer;
    ...
    .line 396
    .local v2, "size":I
    invoke-virtual {p0, v2}, Lcom/evernote/thrift/protocol/TBinaryProtocol;->checkReadLength(I)V

    .line 398
    iget-object v3, p0, Lcom/evernote/thrift/protocol/TBinaryProtocol;->trans_:Lcom/evernote/thrift/transport/TTransport;

    invoke-virtual {v3}, Lcom/evernote/thrift/transport/TTransport;->getBytesRemainingInBuffer()I
    ...
    invoke-virtual {v3}, Lcom/evernote/thrift/transport/TTransport;->getBuffer()[B

    move-result-object v3

    iget-object v4, p0, Lcom/evernote/thrift/protocol/TBinaryProtocol;->trans_:Lcom/evernote/thrift/transport/TTransport;

    invoke-virtual {v4}, Lcom/evernote/thrift/transport/TTransport;->getBufferPosition()I
    ...
    invoke-virtual {v3, v1, v4, v2}, Lcom/evernote/thrift/transport/TTransport;->readAll([BII)I
...
.method public readByte()B
    ...
    .line 298
    :cond_0
    iget-object v1, p0, Lcom/evernote/thrift/protocol/TBinaryProtocol;->bin:[B
...
.method public readI16()S
    ...
    invoke-virtual {v2, v4}, Lcom/evernote/thrift/transport/TTransport;->consumeBuffer(I)V
    ...
    invoke-direct {p0, v2, v3, v4}, Lcom/evernote/thrift/protocol/TBinaryProtocol;->readAll([BII)I
...
.method public readI64()J
    ...
    invoke-direct {p0, v2, v3, v7}, Lcom/evernote/thrift/protocol/TBinaryProtocol;->readAll([BII)I
...
.method public readMessageBegin()Lcom/evernote/thrift/protocol/TMessage;
    ...
    .line 229
    new-instance v2, Lcom/evernote/thrift/protocol/TProtocolException;

    const-string v3, "Bad version in readMessageBegin"

    invoke-direct {v2, v4, v3}, Lcom/evernote/thrift/protocol/TProtocolException;-><init>(ILjava/lang/String;)V
...
.method public readString()Ljava/lang/String;
    ...
    .line 377
    sget-object v2, Lcom/evernote/thrift/protocol/TBinaryProtocol;->UTF8:Ljava/nio/charset/Charset;
...
.method public writeFieldBegin(Lcom/evernote/thrift/protocol/TField;)V
    .locals 1
    .param p1, "field"    # Lcom/evernote/thrift/protocol/TField;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/evernote/thrift/TException;
        }
...
.method public writeListBegin(Lcom/evernote/thrift/protocol/TList;)V
    .locals 1
    .param p1, "list"    # Lcom/evernote/thrift/protocol/TList;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/evernote/thrift/TException;
        }
...
.method public writeMapBegin(Lcom/evernote/thrift/protocol/TMap;)V
    .locals 1
    .param p1, "map"    # Lcom/evernote/thrift/protocol/TMap;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/evernote/thrift/TException;
        }
...
.method public writeMessageBegin(Lcom/evernote/thrift/protocol/TMessage;)V
    .locals 3
    .param p1, "message"    # Lcom/evernote/thrift/protocol/TMessage;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/evernote/thrift/TException;
        }
    ...
    .prologue
    .line 92
    iget-boolean v1, p0, Lcom/evernote/thrift/protocol/TBinaryProtocol;->strictWrite_:Z
    ...
    iget-byte v2, p1, Lcom/evernote/thrift/protocol/TMessage;->type:B
    ...
    invoke-virtual {p0, v1}, Lcom/evernote/thrift/protocol/TBinaryProtocol;->writeString(Ljava/lang/String;)V

    .line 96
    iget v1, p1, Lcom/evernote/thrift/protocol/TMessage;->seqid:I

    invoke-virtual {p0, v1}, Lcom/evernote/thrift/protocol/TBinaryProtocol;->writeI32(I)V
    ...
    invoke-virtual {p0, v1}, Lcom/evernote/thrift/protocol/TBinaryProtocol;->writeByte(B)V
...
.method public writeSetBegin(Lcom/evernote/thrift/protocol/TSet;)V
    .locals 1
    .param p1, "set"    # Lcom/evernote/thrift/protocol/TSet;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lcom/evernote/thrift/TException;
        }
...
.method public writeString(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lcom/evernote/thrift/protocol/TBinaryProtocol;->writeI32(I)V
    ...
    invoke-virtual {v2, v0, v4, v3}, Lcom/evernote/thrift/transport/TTransport;->write([BII)V
...
.method public writeStructBegin(Lcom/evernote/thrift/protocol/TStruct;)V
    .locals 0
    .param p1, "struct"    # Lcom/evernote/thrift/protocol/TStruct;
