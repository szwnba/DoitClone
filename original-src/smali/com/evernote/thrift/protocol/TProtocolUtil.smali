...
.method public static skip(Lcom/evernote/thrift/protocol/TProtocol;B)V
    .locals 1
    .param p0, "prot"    # Lcom/evernote/thrift/protocol/TProtocol;
    .param p1, "type"    # B
...
.method public static skip(Lcom/evernote/thrift/protocol/TProtocol;BI)V
    ...
    .line 74
    new-instance v5, Lcom/evernote/thrift/TException;

    const-string v6, "Maximum skip depth exceeded"

    invoke-direct {v5, v6}, Lcom/evernote/thrift/TException;-><init>(Ljava/lang/String;)V
    ...
    iget-byte v5, v0, Lcom/evernote/thrift/protocol/TField;->type:B
    ...
    invoke-static {p0, v5, v6}, Lcom/evernote/thrift/protocol/TProtocolUtil;->skip(Lcom/evernote/thrift/protocol/TProtocol;BI)V
    ...
    .line 128
    .end local v0    # "field":Lcom/evernote/thrift/protocol/TField;
    :pswitch_9
    ...
    .line 129
    .local v3, "map":Lcom/evernote/thrift/protocol/TMap;
    const/4 v1, 0x0

    .local v1, "i":I
    :goto_2
    iget v5, v3, Lcom/evernote/thrift/protocol/TMap;->size:I

    if-ge v1, v5, :cond_2

    .line 130
    iget-byte v5, v3, Lcom/evernote/thrift/protocol/TMap;->keyType:B
    ...
    .line 131
    iget-byte v5, v3, Lcom/evernote/thrift/protocol/TMap;->valueType:B
    ...
    .line 138
    .end local v1    # "i":I
    .end local v3    # "map":Lcom/evernote/thrift/protocol/TMap;
    :pswitch_a
    ...
    .line 139
    .local v4, "set":Lcom/evernote/thrift/protocol/TSet;
    const/4 v1, 0x0

    .restart local v1    # "i":I
    :goto_3
    iget v5, v4, Lcom/evernote/thrift/protocol/TSet;->size:I

    if-ge v1, v5, :cond_3

    .line 140
    iget-byte v5, v4, Lcom/evernote/thrift/protocol/TSet;->elemType:B
    ...
    .line 147
    .end local v1    # "i":I
    .end local v4    # "set":Lcom/evernote/thrift/protocol/TSet;
    :pswitch_b
    ...
    .line 148
    .local v2, "list":Lcom/evernote/thrift/protocol/TList;
    const/4 v1, 0x0
    ...
    .line 149
    iget-byte v5, v2, Lcom/evernote/thrift/protocol/TList;->elemType:B
