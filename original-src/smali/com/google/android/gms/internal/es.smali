...
.method public cu()Lcom/google/android/gms/plus/model/people/Person;
    .locals 6

    new-instance v0, Lcom/google/android/gms/internal/eq;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->getDisplayName()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->getId()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->getImage()Lcom/google/android/gms/plus/model/people/Person$Image;

    move-result-object v3

    check-cast v3, Lcom/google/android/gms/internal/eq$d;

    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->getObjectType()I

    move-result v4

    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->getUrl()Ljava/lang/String;

    move-result-object v5

    invoke-direct/range {v0 .. v5}, Lcom/google/android/gms/internal/eq;-><init>(Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/internal/eq$d;ILjava/lang/String;)V
...
.method public synthetic freeze()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->cu()Lcom/google/android/gms/plus/model/people/Person;
...
.method public synthetic getEmails()Ljava/util/List;
    .locals 1

    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->cq()Ljava/util/ArrayList;
...
.method public getImage()Lcom/google/android/gms/plus/model/people/Person$Image;
    ...
    new-instance v0, Lcom/google/android/gms/internal/eq$d;

    const-string v1, "image"

    invoke-virtual {p0, v1}, Lcom/google/android/gms/internal/es;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/google/android/gms/internal/eq$d;-><init>(Ljava/lang/String;)V
...
.method public getObjectType()I
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/eq$f;->C(Ljava/lang/String;)I
...
.method public synthetic getOrganizations()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->cr()Ljava/util/ArrayList;
...
.method public synthetic getPlacesLived()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->cs()Ljava/util/ArrayList;
...
.method public synthetic getUrls()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/es;->ct()Ljava/util/ArrayList;
