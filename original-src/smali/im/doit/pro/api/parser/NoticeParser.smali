.class public Lim/doit/pro/api/parser/NoticeParser;
.super Lim/doit/pro/api/parser/BaseParser;
.source "NoticeParser.java"
...
# static fields
.field private static noticeParser:Lim/doit/pro/api/parser/NoticeParser;
...
.method public static getInstance()Lim/doit/pro/api/parser/NoticeParser;
    .locals 1

    .prologue
    .line 13
    sget-object v0, Lim/doit/pro/api/parser/NoticeParser;->noticeParser:Lim/doit/pro/api/parser/NoticeParser;

    if-nez v0, :cond_0

    .line 14
    new-instance v0, Lim/doit/pro/api/parser/NoticeParser;

    invoke-direct {v0}, Lim/doit/pro/api/parser/NoticeParser;-><init>()V

    sput-object v0, Lim/doit/pro/api/parser/NoticeParser;->noticeParser:Lim/doit/pro/api/parser/NoticeParser;
...
# virtual methods
.method public serializeForDeleted(Lim/doit/pro/model/Notice;)Ljava/lang/String;
    .locals 4
