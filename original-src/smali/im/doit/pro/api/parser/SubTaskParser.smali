.class public Lim/doit/pro/api/parser/SubTaskParser;
.super Lim/doit/pro/api/parser/BaseParser;
.source "SubTaskParser.java"
...
# static fields
.field private static subtaskParser:Lim/doit/pro/api/parser/SubTaskParser;
...
.method public static getInstance()Lim/doit/pro/api/parser/SubTaskParser;
    .locals 1

    .prologue
    .line 13
    sget-object v0, Lim/doit/pro/api/parser/SubTaskParser;->subtaskParser:Lim/doit/pro/api/parser/SubTaskParser;

    if-nez v0, :cond_0

    .line 14
    new-instance v0, Lim/doit/pro/api/parser/SubTaskParser;

    invoke-direct {v0}, Lim/doit/pro/api/parser/SubTaskParser;-><init>()V

    sput-object v0, Lim/doit/pro/api/parser/SubTaskParser;->subtaskParser:Lim/doit/pro/api/parser/SubTaskParser;
...
# virtual methods
.method public serializeForArchived(Lim/doit/pro/model/SubTask;)Ljava/lang/String;
    .locals 4
...
.method public serializeForCompleted(Lim/doit/pro/model/SubTask;)Ljava/lang/String;
    .locals 4
    .param p1, "t"    # Lim/doit/pro/model/SubTask;
...
.method public serializeForDeleted(Lim/doit/pro/model/SubTask;)Ljava/lang/String;
    .locals 4
    .param p1, "t"    # Lim/doit/pro/model/SubTask;
...
.method public serializeForTrashed(Lim/doit/pro/model/SubTask;)Ljava/lang/String;
    .locals 4
    .param p1, "t"    # Lim/doit/pro/model/SubTask;
