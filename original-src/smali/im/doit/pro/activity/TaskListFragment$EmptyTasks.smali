.class Lim/doit/pro/activity/TaskListFragment$EmptyTasks;
...
.method private constructor <init>(Lim/doit/pro/activity/TaskListFragment;)V
    ...
    .prologue
    .line 397
    iput-object p1, p0, Lim/doit/pro/activity/TaskListFragment$EmptyTasks;->this$0:Lim/doit/pro/activity/TaskListFragment;
...
.method synthetic constructor <init>(Lim/doit/pro/activity/TaskListFragment;Lim/doit/pro/activity/TaskListFragment$EmptyTasks;)V
    .locals 0

    .prologue
    .line 397
    invoke-direct {p0, p1}, Lim/doit/pro/activity/TaskListFragment$EmptyTasks;-><init>(Lim/doit/pro/activity/TaskListFragment;)V
...
.method protected bridge varargs synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lim/doit/pro/activity/TaskListFragment$EmptyTasks;->doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Void;
    ...
    invoke-virtual {v4}, Lim/doit/pro/db/persist/TaskDao;->findTrash()Ljava/util/ArrayList;
    ...
    .line 408
    invoke-virtual {v4}, Lim/doit/pro/db/persist/ProjectDao;->findTrash()Ljava/util/ArrayList;
    ...
    invoke-virtual {v4}, Lim/doit/pro/db/persist/GoalDao;->findTrash()Ljava/util/ArrayList;
    ...
    invoke-virtual {v5, v1}, Lim/doit/pro/db/persist/TaskDao;->delete(Lim/doit/pro/model/Task;)V
    ...
    invoke-virtual {v5, v1}, Lim/doit/pro/db/persist/ProjectDao;->delete(Lim/doit/pro/model/Project;)V
    ...
    invoke-virtual {v5, v1}, Lim/doit/pro/db/persist/GoalDao;->delete(Lim/doit/pro/model/Goal;)V
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lim/doit/pro/activity/TaskListFragment$EmptyTasks;->onPostExecute(Ljava/lang/Void;)V
...
.method protected onPostExecute(Ljava/lang/Void;)V
    ...
    .line 424
    iget-object v0, p0, Lim/doit/pro/activity/TaskListFragment$EmptyTasks;->this$0:Lim/doit/pro/activity/TaskListFragment;
    ...
    iget-object v1, p0, Lim/doit/pro/activity/TaskListFragment$EmptyTasks;->this$0:Lim/doit/pro/activity/TaskListFragment;
    ...
    invoke-static {v0, v2}, Lim/doit/pro/activity/TaskListFragment;->access$1(Lim/doit/pro/activity/TaskListFragment;Lim/doit/pro/activity/TaskListFragment$EmptyTasks;)V
