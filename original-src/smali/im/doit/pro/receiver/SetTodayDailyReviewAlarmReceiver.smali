.class public Lim/doit/pro/receiver/SetTodayDailyReviewAlarmReceiver;
.super Landroid/content/BroadcastReceiver;
.source "SetTodayDailyReviewAlarmReceiver.java"


# static fields
.field public static final ACTION:Ljava/lang/String; = "im.doit.pro.receiver.SetTodayDailyReviewAlarmReceiver"

.field public static final START_DAILY_REVIEW_REQUEST_CODE:I = 0x259
...
.method private getCurrentDailyReviewIndex()I
    .locals 4
...
.method private isCurrentDailyReviewIndexValid(Ljava/util/ArrayList;I)Z
    .locals 1
    .param p2, "index"    # I
...
.method private setTodayDailyReviewAlarm(Landroid/content/Context;Ljava/util/ArrayList;I)V
    .locals 10
    ...
    .line 48
    .local v4, "reviewTime":Ljava/util/Calendar;
    const/4 v8, 0x0
    ...
    .line 55
    const-string v8, "im.doit.pro.receiver.StartTodayDailyReviewReceiver"
    ...
    .end local v4    # "reviewTime":Ljava/util/Calendar;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .prologue
    .line 26
    const-string v2, "**SetTodayDailyReviewAlarmReceiver**"
    ...
    invoke-direct {p0}, Lim/doit/pro/receiver/SetTodayDailyReviewAlarmReceiver;->getCurrentDailyReviewIndex()I

    move-result v0

    .line 32
    .local v0, "index":I
    invoke-direct {p0, v1, v0}, Lim/doit/pro/receiver/SetTodayDailyReviewAlarmReceiver;->isCurrentDailyReviewIndexValid(Ljava/util/ArrayList;I)Z
    ...
    .line 33
    invoke-direct {p0, p1, v1, v0}, Lim/doit/pro/receiver/SetTodayDailyReviewAlarmReceiver;->setTodayDailyReviewAlarm(Landroid/content/Context;Ljava/util/ArrayList;I)V
